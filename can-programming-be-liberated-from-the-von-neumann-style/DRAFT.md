...
$$
\def\Def#1{\textbf{Def } \text{#1} \equiv}
\def\o{\circ}
\def\a{\alpha}
\def\f#1{\text{#1}}
\Def{MM} \a \a \f{IP} \o \a \f{distl} \o \f{distr} \o [ 1, \f{trans} \o 2 ]
$$  
...
$$
\textbf{Def } \text{MM'} \equiv \alpha \alpha \text{IP} \circ \alpha \text{distl} \circ \text{distr}
$$ 
...
$$
\textbf{Def } \text{R} \equiv \text{null} \circ 1 \to \bar{\phi};
...
\def\o{\circ}
\def\eq{\equiv}
\text{MM} \eq \text{MM'} \o [1, \trans \o 2] \eq \text{R} \o [1, \trans \o 2]
$$
